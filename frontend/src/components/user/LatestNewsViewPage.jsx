    ...
    <div className="px-4 bg-gradient-to-br from-gray-50 via-purple-50/30 to-pink-50/30 dark:from-gray-900 dark:via-purple-950/20 dark:to-pink-950/20 min-h-screen py-8">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-grow basis-[75%]">
          <div className="relative rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-purple-100 dark:border-purple-800/50 bg-white dark:bg-gray-800">
            ...
            <div className="relative p-8 md:p-12">
              ...
              {news && (
                <>
                  ...
                  {/* Title */}
                  <h1 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-center mb-6 leading-tight bg-gradient-to-r from-gray-900 via-purple-900 to-pink-900 dark:from-gray-100 dark:via-purple-200 dark:to-pink-200 bg-clip-text text-transparent drop-shadow-sm">
                    {news.title || "Untitled"}
                  </h1>
                  ...
                  <div className="relative mb-2">
                    <div className="absolute inset-0 flex items-center">
                      <div className="w-full border-t-2 border-gradient-to-r from-transparent via-purple-300 dark:via-purple-700 to-transparent"></div>
                    </div>
                  ...
                  <div className="mt-5 flex items-center justify-start gap-3 flex-wrap">
                    ...
                    <button
                      onClick={handleSave}
                      disabled={isSaved}
                      className={`group flex items-center gap-1.5 px-3 py-1.5 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-medium text-xs rounded-full border border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500 shadow-sm hover:shadow-md transition-all duration-300 ${isSaved ? 'cursor-not-allowed opacity-70' : 'hover:scale-105'}`}
                    >
