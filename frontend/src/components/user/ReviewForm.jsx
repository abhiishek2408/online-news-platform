...
const ReviewForm = () => {
  ...
  return (
    <div className={`flex-col lg:flex-row justify-between w-full max-w-[1200px] mx-auto mt-5 items-stretch ${loading ? 'animate-pulse bg-gray-100 p-5 rounded-xl' : 'bg-white p-3'}`}>
      {loading ? (
        ...
        <section className="bg-white shadow-sm rounded-xl p-6 border border-gray-200 w-full">
          <h3 className="text-xl font-semibold text-grey-900 mb-4 flex items-center">
