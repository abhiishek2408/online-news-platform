...
const TopHighlight = () => {
  ...
  return (
    <div className="flex flex-col w-full min-h-[590px] gap-4 rounded-xl">
      <div className="min-h-[500px] w-full rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-700 dark:bg-gray-800">
          ...
          {loading ? (
            <div className="p-6 space-y-6 animate-pulse">
              ...
              <div className="space-y-3">
                <div className="h-8 bg-gradient-to-r from-purple-200 to-pink-200 dark:from-purple-900 dark:to-pink-900 rounded-lg w-3/4"></div>
                <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded w-1/2"></div>
              </div>
              
              {/* Skeleton Image */}
              <div className="h-64 bg-gradient-to-br from-gray-200 via-gray-300 to-gray-200 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700 rounded-xl"></div>
            ...
            highlight && (
              <>
                {/* Header Section */}
                <div className="relative p-6 pb-5 border-b-2 border-purple-200 dark:border-purple-800/50 overflow-hidden">
                  ...
                  <div className="relative flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h2 className="text-3xl font-extrabold bg-gradient-to-r from-purple-600 via-purple-700 to-pink-600 dark:from-purple-400 dark:via-purple-500 dark:to-pink-500 bg-clip-text text-transparent tracking-tight">
                          Top Highlight
                        </h2>
                        <p className="text-gray-600 dark:text-gray-400 text-sm mt-1 flex items-center gap-1.5">
                    ...
                    {/* Decorative badge */}
                    <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-600 via-purple-700 to-pink-600 dark:from-purple-700 dark:via-purple-800 dark:to-pink-700 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-purple-700 dark:border-purple-600">
                ...
                {/* Content Section */}
                <div className="p-6 pt-4 flex-1 flex flex-col space-y-5">
                  {/* Title */}
                  <Link
                    to={`/user/dashboard/articleviewpage?id=${highlight._id}`}
                    className="group relative block p-5 pb-3 -mx-2 rounded-2xl hover:bg-gradient-to-br hover:from-purple-50/50 hover:via-pink-50/30 hover:to-transparent dark:hover:from-purple-900/20 dark:hover:via-pink-900/10 dark:hover:to-transparent transition-all duration-300"
                  >
                    ...
                    <h3 className="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white leading-tight tracking-tight group-hover:bg-gradient-to-r group-hover:from-purple-600 group-hover:via-purple-700 group-hover:to-pink-600 dark:group-hover:from-purple-400 dark:group-hover:via-purple-500 dark:group-hover:to-pink-400 group-hover:bg-clip-text group-hover:text-transparent transition-all duration-500 line-clamp-3 drop-shadow-sm">
                      {highlight.title}
                    </h3>
                  </Link>
                  ...
                  <Link 
                    to={`/user/dashboard/articleviewpage?id=${highlight._id}`}
                    className="group relative block rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300"
                  >
                    <div className="relative overflow-hidden">
                      ...
                      <div className="absolute bottom-4 right-4 bg-white dark:bg-gray-800 text-purple-600 dark:text-purple-400 px-4 py-2 rounded-full font-semibold text-sm opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 shadow-lg">
                        Read More →
                      </div>
                    </div>
                  </Link>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className={`group flex items-center gap-1.5 px-3 py-1.5 ${
                            isBookmarked 
                              ? 'bg-purple-50 border-purple-300 text-purple-600 dark:bg-purple-900/20 dark:border-purple-700 dark:text-purple-400' 
                              : 'bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 hover:border-gray-400 dark:hover:border-gray-500'
                          } font-medium text-xs rounded-full border ${
                            isBookmarked ? '' : 'border-gray-300 dark:border-gray-600'
                          } shadow-sm hover:shadow-md transition-all duration-300 ${
                            isBookmarked ? 'cursor-not-allowed' : 'hover:scale-105'
                          }`}
                        >
                          <svg 
                        ...
                        <button
                          ...
                          className={`group flex items-center gap-1.5 px-3 py-1.5 ${
                            ...
                            isLiked ? '' : 'border-gray-300 dark:border-gray-600'
                          } shadow-sm hover:shadow-md transition-all duration-300 ${
                            isLiked ? 'cursor-not-allowed' : 'hover:scale-105'
                          }`}
                        >
                          <svg 
                            className="w-3.5 h-3.5 transition-all duration-300" 
